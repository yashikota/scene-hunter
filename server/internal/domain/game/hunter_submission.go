...
var (
	...
	ErrInvalidSubmittedAtSeconds = errors.New("invalid submitted_at_seconds: must be between 0 and 60")
)
...
func NewHunterSubmission(userID uuid.UUID, imageID string, submittedAtSeconds int) (*HunterSubmission, error) {
